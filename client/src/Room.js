...
const Room = ({ userNo, socket, setUsers, setUserNo }) => {
  ...
  return (
    <div className="container-fluid">
      <div className="row">
        <h1 className="display-5 pt-4 pb-2 text-center text-primary" style={{ fontSize: '40px', fontWeight: '600' }}>
          Welcome to Whiteboard!</h1>
          <h1 className="display-5 pb-3 text-center">Users online :{userNo}
        </h1>
      </div>
      <div className="row justify-content-center align-items-center text-center py-2">
        <div className="col-md-2">
          <div className="color-picker d-flex align-items-center justify-content-center text-bold">
            Color Picker : &nbsp;
            <input
              type="color"
              value={color}
